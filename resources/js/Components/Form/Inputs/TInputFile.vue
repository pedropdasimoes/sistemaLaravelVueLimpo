<template>
    <div>
        ...
        <!--Input-->
        <div :class="['flex border items-center overflow-hidden', radiusStyle, $page.props.auth.user.theme, 'colorInput']"
        >
            <input
                ref="input"
                class="hidden"
            ...
            <div class="flex flex-grow-0 flex-shrink-0 items-center">
                ...
                <button
                    ...
                    :class="[$page.props.auth.user.theme, 'buttonInputFile']"
                    type="button"
        ...
        <transition name="fade">
            <div
                ...
                :class="['flex flex-col border w-full p-4 mt-2', radiusStyle, $page.props.auth.user.theme, 'colorInput']"
