...
use App\Http\Controllers\ArquivosDadosController;
...
//PainelInicial
Route::get('/authGoogle/redirect', [SocialiteController::class, 'redirect'])->name('/authGoogle/redirect');
Route::get('/authGoogle/callback', [SocialiteController::class, 'callback'])->name('/authGoogle/callback');
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::post('alter-theme', [UsuarioController::class, 'alterTheme'])->name('alter-theme');
    

    //Erros
    Route::get('erro', function () {
        return Inertia::render('Admin/Erro/Erro');
    })->name('erro');
    ...
    Route::get('table', function () {
        return Inertia::render('Samples/Components/Table', ['users' => User::all()]);
    })->name('table');
    //TODO: Toastr Feature
    ...
    Route::get('layout-content-box', function () {
    ...
    Route::get('form-inline-repeatable-field', function () {
    ...
    Route::get('form-select-input', function () {
        return Inertia::render('Samples/FormElements/SelectInput', ['users' => User::all()]);
    })->name('form-select-input');
    Route::get('form-multi-select-input', function () {
        return Inertia::render('Samples/FormElements/MultiSelectInput', ['users' => User::all()]);
