    ...
    data(){
        return {
            solidColors: {
                ...
                'solid-blue': 'bg-blue-400 border-blue-400',
                ...
                'solid-dark': 'bgDarkElementar',
                'solid-cosmic': 'bgCosmicElementar',
                'solid-light': 'bgLightElementar',
            },
            lightColors: {
                'light-red': 'bg-red-200 border border-red-500',
                'light-blue': 'bg-blue-200 border border-blue-400',
            ...
            solidTextColors: {
                ...
                'solid-cosmic': 'text-gray-100',
                'solid-light': 'text-gray-700',
            },
            lightTextColors: {
                'light-red': 'text-red-700',
                'light-blue': 'text-blue-500',
            ...
            solidHoverColors: {
                ...
                'solid-dark': 'bgDarkElementarHover',
                'solid-cosmic': 'bgCosmicElementarHover',
                'solid-light': 'bgLightElementarHover',
            },
            lightHoverColors: {
