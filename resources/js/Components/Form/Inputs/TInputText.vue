<template>
    ...
    >
        ...
        <input
            :class="['form-input rounded-l-none h-10 ml-10',radiusStyle,$page.props.auth.user.theme, 'colorInput']"
            :type="type"
            :id="id"
    ...
    <input
        v-else
        :class="['form-input h-10', radiusStyle,$page.props.auth.user.theme, 'colorInput']"
        :type="type"
        :id="id"
        :placeholder="placeholder"
        :value="value"
