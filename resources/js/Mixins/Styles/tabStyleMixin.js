    ...
    data() {
        return {
            tab1Colors: {
                ...
                'solid-dark': 'bg-gray-50 border-gray-300 text-gray-600 mt-1 -mb-1',
                'solid-cosmic': 'bg-gray-50 border-gray-300 text-gray-600 mt-1 -mb-1',
                'solid-light': 'bg-blue-200 border-blue-300 text-blue-600 mt-1 -mb-1',
            },
            tab2Colors: {
                ...
                'solid-dark': 'bg-gray-200 border border-gray-500',
                'solid-cosmic': 'bg-gray-200 border border-gray-500',
                'solid-light': 'bg-blue-500 text-gray-100',
            },
            tab1ActiveColors: {
                'solid-red': 'bg-red-500 text-gray-100',
                'solid-blue': 'bg-blue-500 text-gray-100',
                ...
                'solid-dark': 'bg-gray-200 border border-b-0 border-gray-500 text-gray-600',
                'solid-cosmic': 'bg-gray-200 border border-b-0 border-gray-500 text-gray-600',
                'solid-light': 'bg-blue-500 text-gray-100',
            },
            tabContentColors: {
                ...
                'solid-dark': 'bg-gray-100 border border-gray-500',
                'solid-cosmic': 'bg-gray-100 border border-gray-500',
                'solid-light': 'bg-gray-100 border-blue-500 text-gray-600',
            },
            tab2ActiveColors: {
                ...
                'solid-dark': 'bg-gray-500 text-gray-100 border border-gray-500',
                'solid-cosmic': 'bg-gray-500 text-gray-100 border border-gray-500',
                'solid-light': 'bg-blue-100 text-blue-600',
            },
            radiusStyles: {
                '0': {
                    content: null,
