    ...
    data() {
        return {
            iconColors: {
                ...
                'solid-dark': 'bg-gray-500 text-gray-500 border-gray-500',
                'solid-cosmic': 'bg-gray-500 text-gray-500 border-gray-500',
                'solid-light': 'bg-gray-500 text-gray-500 border-gray-500',
            },
            diffStyles: {
