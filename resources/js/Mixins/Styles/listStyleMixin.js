    ...
    data() {
        return {
            listColors: {
                ...
                'solid-indigo': "bg-indigo-800 text-white border-indigo-100 hover:bg-indigo-100 hover:text-indigo-700 focus:bg-indigo-100 focus:text-indigo-700",
                ...
                'solid-dark': 'solid-dark bgList',
                'solid-cosmic': 'solid-cosmic bgList',
                'solid-light': 'bg-white border-gray-300 text-gray-700 hover:bg-gray-100 hover:text-white-700 focus:bg-gray-100 focus:text-white-700'
            ...
            listActiveColors: {
                ...
                'solid-dark': 'bgDarkElementar text-white',
                'solid-cosmic': 'bgCosmicElementar text-white',
                'solid-light': 'border-gray-300 bg-gray-200 text-gray-700 hover:bg-gray-300'
