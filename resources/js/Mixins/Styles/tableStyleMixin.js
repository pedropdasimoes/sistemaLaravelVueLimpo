    ...
    data() {
        return {
            headerColors: {
                ...
                'solid-dark': 'solid-dark headerTable ',
                'solid-cosmic': 'solid-cosmic headerTable ',
            ...
            contentColors: {
                ...
                'solid-dark': 'solid-dark contentTable',
                'solid-cosmic': 'solid-cosmic contentTable',
                'solid-light': 'bg-blue-500 hover:bg-blue-200 border-blue-300',
            },
            scrollColors: {
                ...
                'solid-dark': 'scrollbar-thumb-indigo-800 scrollbar-track-indigo-600',
                'solid-cosmic': 'scrollbar-thumb-indigo-800 scrollbar-track-indigo-600',
                'solid-light': 'scrollbar-thumb-blue-500 scrollbar-track-blue-300',
            },
            tableBorderColors: {
                ...
                'solid-dark': 'solid-dark border border-transparent',
                'solid-cosmic': 'solid-cosmic border border-transparent',
                'solid-light': 'border border-transparent',
            }
        }
    },
    computed: {
