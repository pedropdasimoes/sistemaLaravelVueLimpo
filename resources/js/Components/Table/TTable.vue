            ...
            <div class="table-top-container">
                ...
                <div v-if="searchable.length > 0" class="table-top-left">
                    ...
                    <input
                        ...
                        :class="[$page.props.auth.user.theme, 'inputSearchBox']"
                    />
                    ...
                    <div
                        ...
                        :class="[$page.props.auth.user.theme, 'inputSeacrhPagination']"
                    >
                        {{ pagedItem }}
                    </div>
                    <div
                        ...
                        :class="[$page.props.auth.user.theme, 'numerosTabela']"
                    >
                        <ul>
                            <li v-for="i in 5" class="table-top-pagination-li"  @click=" pagedItem = i * 5; showPagedItemChooser = false;">
                                {{ i * 5 }}
                            </li>
                        </ul>
                    </div>
            ...
            <table class="w-full min-h-fit">
                ...
                <tbody class="bg-white">
                    <tr v-if="paginatedContent.length === 0">
                        <td :class="[noContentStyle, $page.props.auth.user.theme, 'nenhumDado']" :colspan="header.length">
                    ...
                    <tr
                        ...
                        :class="[
                            ...
                            contentColors[color],
                            zebra && index % 2 === 0
                                ? 'bg-opacity-0 zebraImpar'
                                : 'bg-opacity-10 zebraPar', 
