    ...
    data() {
        return {
            paginateColors: {
                ...
                'solid-dark': 'solid-dark paginacao border',
                'solid-cosmic': 'solid-cosmic paginacao border',
                'solid-light': 'bg-blue-300 text-gray-100',
            },
            paginateActiveColors: {
                ...
                'solid-dark': 'solid-dark paginacaoAtiva border',
                'solid-cosmic': 'solid-cosmic paginacaoAtiva border',
            ...
            arrowColors: {
                ...
                'solid-dark': 'solid-dark paginacaoArrow',
                'solid-cosmic': 'solid-cosmic paginacaoArrow',
                'solid-light': 'bg-blue-500 text-blue-300 hover:text-blue-500',
            }
        }
    },
    computed: {
