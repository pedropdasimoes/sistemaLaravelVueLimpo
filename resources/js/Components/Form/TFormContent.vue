<template>
    <div class="w-full">
        <form :enctype="enctype" @submit.prevent="$emit('submitted')">
            <!--Form Body-->
            <div
                class="mt-5 md:mt-0 md:col-span-2 bg-white shadow-xl rounded-md"
                :class="[$page.props.auth.user.theme, 'bgFormContent']"
            >
                <slot></slot>
                            ...
                            >
                                <g transform="rotate(0 50 50)">
                                    <rect
                                        ...
                                        width="6"
                                        height="12"
                                        :fill="[$page.props.auth.user.theme === 'solid-dark' ? '#FFF' : '#0055a5']"
                                    >
                                        <animate
